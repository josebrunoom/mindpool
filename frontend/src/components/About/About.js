...
import iconMapa from '../../assets/desktop/mapa.png';
    ...
    >
      <Box w="35%" float="left">
          ...
          <Text
            ...
            lineHeight="45px"
          >
            Let your employees voice impact your company. They have important knowledge.
          </Text>
          <Text
          mt="16px"
          fontSize='20px'
      ...
      <Box w="65%" float="left" textAlign="center">
        <Select w="50%" margin="auto" mb="10" boxShadow="0px 10px 20px 0px rgba(0, 0, 0, 0.1)">
